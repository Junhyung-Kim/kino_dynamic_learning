...
def loadmodel(kkkk):
    ...
    for ss in range(0, 4):
        print(ss)
        print(database['Right']['x_state'][k][ss][0] + 0.02 * database['Right']['x_state'][k][ss+1][1]-database['Right']['x_state'][k][ss+1][0])
        print(database['Right']['x_state'][k][ss][4] + 0.02 * database['Right']['x_state'][k][ss+1][5]-database['Right']['x_state'][k][ss+1][4])
        print(database['Right']['x_state'][k][ss])
...
def talker():
    ...
    for kkkk in range(0,1):
        ...
        f3 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=15/newfile.txt", 'w')
        f1 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=15/newfile1.txt", 'w')
        f2 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=15/newfile2.txt", 'w')
        zmpx = []
        zmpy = []
        #print(zmp_refx)
        ...
        for time1 in range(0, 1):#len(database1['Right']['vel_trajs'])):
            ...
            if time1 % 200 == 0:
                filename3 = '/home/jhk/ssd_mount2/beforedata/ssp1/Fdyn_data7_test.txt' #filename + filename1 + filename2

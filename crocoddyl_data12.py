...
def PCAlearning():
    ...
    with open('/home/jhk/ssd_mount/beforedata/i=4-8, J=0-10,2/', 'rb') as f:
...
def talker():
    ...
    with open('/home/jhk/ssd_mount/beforedata/i=8-9,j=0-10,2/Fdyn_data7.txt', 'rb') as f:
    #with open('/home/jhk/ssd_mount/afterdata/i=8-9,j=0-10,2/Fdyn_data5.txt', 'rb') as f:
        database = pickle.load(f,  encoding='iso-8859-1')
    f.close()
        ...
        while booltemp == True:
            ...
            if iter_ % 2 == 0:
                ...
                if iter_ == 0:
                    print("c")
                    print(time1)
                    css = ddp.solve(xs, us, 1000, False, 0.0001)
            else:
                print("b")
                css = ddp.solve(ddp.xs, ddp.us, 1000, False, 0.0001)
            c_end = time.time()
            ...
            if booltemp1 == False:
                ...
                with open('/home/jhk/ssd_mount/beforedata/i=8-9,j=0-10,2/filename3.pkl', 'wb') as f:

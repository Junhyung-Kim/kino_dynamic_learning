...
def loadmodel():
    ...
    with open('/home/jhk/ssd_mount/beforedata/ssp2/i=4,j=6-10,10,10/Fdyn_data5.txt', 'rb') as f:
...
def talker():
    ...
    for time1 in range(0, len(database1['Right']['vel_trajs'])):
        ...
        with open('/home/jhk/ssd_mount/beforedata/ssp2/i=4,j=6-10,10,10/Fdyn_data7.txt','wb') as f:

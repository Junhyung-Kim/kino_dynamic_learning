            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 1, False)#, 0.001)
                        #problemWithRK4.calc(xs,us) #3.33, 0.88
                        #problemWithRK4.calcDiff(xs,us)
                        c_end = time.time()
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 30, False, 0.001)
                ...
                iter_ = iter_ + 1
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp1/i=5/filename4_'

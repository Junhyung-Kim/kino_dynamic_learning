...
def talker():
    ...
    print("start")
    for step_time in range(2, 50):
        f = open("/home/jhk/ssd_mount/lfoot2_final1_2.txt", 'r')
        f1 = open("/home/jhk/ssd_mount/rfoot2_final1_2.txt", 'r')
        f2 = open("/home/jhk/ssd_mount/zmp5_final1_1.txt", 'r')
        ...
        filename = '/home/jhk/ssd_mount/beforedata/ssp1_final'
        #ilename1 = str('/')
        filename2 = '/i=1/Fdyn_data7.txt'
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 5000, False)#, 0.01)
                ...
                iter_ = iter_ + 1
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp1_final/i=1/filename3_'

...
def talker():
    ...
    for time_step in range(0, 1):
        ...
        with open('/home/jhk/ssd_mount/beforedata/ssp2/timestep=0/filename3_5_0.pkl', 'rb') as f:
            database = pickle.load(f,  encoding='iso-8859-1')
        f.close()
        ...
        e = 0
        for time1 in range(0, 1000):#len(database_['Right']['u_trajs'])):
                ...
                for j1 in range(0,1): #4
                    ...
                    while booltemp == True:
                        ...
                        if iter_ == 0:
                            ...
                            print("a")
                            css = ddp.solve(xs, us, 3000, False, 0.01)
                            #css = ddp.solve(xs, us, 1, False, 0.1)

                        else:
                            print("b")
                            ddp.th_stop = 0.00000001
                            css = ddp.solve(ddp.xs, ddp.us, 2000, False)
                        c_end = time.time()
                        ...
                        if time1 % 100 == 0:
                            file_name ='/home/jhk/ssd_mount/beforedata/ssp2/timestep=0/filename3_4_1000_dist_'
                            file_name2 = '.pkl'
                            file_name3 = file_name + str(time_step) + file_name2

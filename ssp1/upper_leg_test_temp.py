...
def talker():
    ...
    k_ = ["timestep=22_finish220_" ,  "timestep=22_finish2230_",  "timestep=22_finish2233_" , "timestep=22_finish224_",
"timestep=22_finish221_"  , "timestep=22_finish2231_",  "timestep=22_finish2234_"  ,
"timestep=22_finish222_"  , "timestep=22_finish2232_" , "timestep=22_finish223_" , 
    ]

    k_1 = [
        "timestep=23_finish220_final" ,  "timestep=23_finish2230_final",  "timestep=23_finish2233_final" , "timestep=23_finish224_final",
"timestep=23_finish221_final"  , "timestep=23_finish2231_final",  "timestep=23_finish2234_final"  ,
"timestep=23_finish222_final"  , "timestep=23_finish2232_final" , "timestep=23_finish223_final" , 
]

    for kkkk in range(3,len(k_),4):
        modelInitialize()
        walkingSetup()
        footStep()
        cpGenerator()
        #comGenerator(LIPM_bool)u
        swingFootGenerator()
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            for i in range(1, N):
                if LIPM_bool == 1:
                    if i == 1:
                        ...
                        comrefdx = (database['Right']['x_state'][time1][0][0] - data.com[0][0])*hz
                        comrefdy = (database['Right']['x_state'][time1][0][4] - data.com[0][1])*hz

                        RF_d = (array_boundRF_[0] - data.oMf[RFframe_id].translation) * hz
                        LF_d = (array_boundLF_[0] - data.oMf[LFframe_id].translation) * hz
            ...
            '''
            if time1 % 200 == 0:
                filename3 = '/home/jhk/walkingdata/beforedata/ssp1/timestep=27_finish/ssp1_data5_8_02_0.0007.txt' #filename + filename1 + filename2

...
def loadmodel():
    f = open("/home/jhk/walkingdata/beforedata/ssp2/zmp3.txt", 'r')
    f1 = open("/home/jhk/walkingdata/beforedata/ssp2/zmp3.txt", 'r')
    ...
    k_ = [
        ...
        #"timestep=16_finish", "timestep=17_finish", "timestep=18_finish", "timestep=19_finish", "timestep=20_finish",  "timestep=22_finish",  "timestep=23_finish","timestep=24_finish","timestep=25_finish", "timestep=26_finish",
        #"timestep=27_finish","timestep=28_finish","timestep=29_finish","timestep=30_finish","timestep=31_finish","timestep=32_finish","timestep=33_finish","timestep=34_finish","timestep=35_finish","timestep=36_finish","timestep=37_finish","timestep=38_finish","timestep=39_finish",
    ]
    ...
    for kkkk in range(0, len(k_), 1):
        ...
        for i in range(len(database['Right']['x_state'])-1,-1,-1):
            for k in range(1, N):
                ...
                if k == 1:
                    ...
                    if(database['Right']['costs'][i] > 0.03):
                        ...
                        database1['Right']['x_ainputs'].append(database['Right']['x_inputs'][i])
                ...
                if (database['Right']['x_state'][i][k][6] > array_boundy_[k][1]) or (database['Right']['x_state'][i][k][6] < array_boundy_[k][0]):
                    print("y")
                    print([i,j])
                    print([database['Right']['x_state'][i][k][6],array_boundy_[k][0],array_boundy_[k][1]])
        ...
        with open(filename3, 'wb') as f:
            pickle.dump(database1, f, protocol=pickle.HIGHEST_PROTOCOL)

...
#"timestep=12_finish_re_add",      "timestep=17_finish_re_add",      "timestep=21_finish_re_add",           "timestep=30_finish_re_add",      "timestep=39_finish_re_add",
...
#"timestep=16_finish_re_add",      "timestep=20_finish_re_add",     

# "timestep=24_finish_re_add",      "timestep=29_finish_re_add",      "timestep=38_finish_re_add",  
]
    ...
    test_x_loader = torch.utils.data.DataLoader(dataset=test_yx, batch_size=batch_sizs, shuffle=True)
    ...
    if learn_type == 0:
        ...
        file_name = '/home/jhk/ssd_mount/beforedata/ssp1/cnnEarly'
        file_name2 = '0_'
        file_name3 = '.pkl'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3       
...
def talker():
    ...
    for i in range(0, 49, 2):#learning_data_num):
        PCAlearning(i)
    k = adsfasdff
    print("start")

...
def loadmodel():
    f = open("/home/jhk/ssd_mount/beforedata/ssp1/zmp3.txt", 'r')
    f1 = open("/home/jhk/ssd_mount/beforedata/ssp1/zmp3.txt", 'r')
    f2 = open("/home/jhk/ssd_mount/beforedata/ssp1/zmp3.txt", 'r')
    ...
    k_ = [
        "timestep=32_finish", 
        #"timestep=16_finish", "timestep=17_finish", "timestep=18_finish", "timestep=19_finish", "timestep=20_finish",  "timestep=22_finish",  "timestep=23_finish","timestep=32_finish","timestep=32_finish", "timestep=26_finish",
    ...
    for kkkk in range(0, len(k_), 1):
        filename = '/home/jhk/ssd_mount/beforedata/ssp1/bb'
        ...
        #print(filename3)
        #print(j1)
        filename3 = filename + '/' + k_[kkkk] + '/' + k_[kkkk] + '2'
        print("total")
        print(len(database['Right']['x_state']))
        print("prev")
        print(prev)

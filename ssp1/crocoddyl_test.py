...
def talker():
    ...
    print("start")
    for step_time in range(14, 15):
        f = open("/home/jhk/walkingdata/beforedata/ssp1/lfoot1.txt", 'r')
        f1 = open("/home/jhk/walkingdata/beforedata/ssp1/rfoot1.txt", 'r')
        ...
        for kkkk in range(6, 500, 7):
            ...
            k_ = [
"Fdyn_data8_0_-0.0007_0.txt",  "Fdyn_data8_1_-0.0007_0.txt",  "Fdyn_data8_2_-0.0021_0.txt",  "Fdyn_data8_3_0.0021_1.txt",   "Fdyn_data8_4_0.0033_1.txt",   "Fdyn_data8_6_-0.0007_0.txt",  "Fdyn_data8_7_0.0007_0.txt",
"Fdyn_data8_0_0.0007_0.txt",   "Fdyn_data8_1_0.0007_0.txt",   "Fdyn_data8_2_0.0021_0.txt",   "Fdyn_data8_3_-0.0033_0.txt",  "Fdyn_data8_5_-0.0007_0.txt",  "Fdyn_data8_6_0.0007_0.txt",   "Fdyn_data8_7_-0.0021_0.txt",
"Fdyn_data8_0_-0.0021_0.txt",  "Fdyn_data8_1_-0.0021_0.txt",  "Fdyn_data8_2_-0.0021_1.txt",  "Fdyn_data8_3_0.0033_0.txt",   "Fdyn_data8_5_0.0007_0.txt",   "Fdyn_data8_6_0.0007_1.txt",   "Fdyn_data8_7_0.0021_0.txt",
"Fdyn_data8_0_0.0021_0.txt",   "Fdyn_data8_1_0.0021_0.txt",   "Fdyn_data8_2_-0.0033_0.txt",  "Fdyn_data8_4_-0.0007_0.txt",  "Fdyn_data8_5_0.0007_1.txt",   "Fdyn_data8_6_-0.0021_0.txt",  "Fdyn_data8_7_-0.0033_0.txt",
"Fdyn_data8_0_-0.0021_1.txt",  "Fdyn_data8_1_-0.0033_0.txt",  "Fdyn_data8_2_0.0033_0.txt",   "Fdyn_data8_4_0.0007s_0.txt",  "Fdyn_data8_5_0.0007_2.txt",   "Fdyn_data8_6_0.0021_0.txt",   "Fdyn_data8_7_0.0033_0.txt",
"Fdyn_data8_0_-0.0033_0.txt",  "Fdyn_data8_1_0.0033_0.txt",   "Fdyn_data8_3_-0.0007_0.txt",  "Fdyn_data8_4_-0.0021_0.txt",  "Fdyn_data8_5_-0.0021_0.txt",  "Fdyn_data8_6_-0.0033_0.txt",  
"Fdyn_data8_0_0.0033_0.txt",   "Fdyn_data8_1_0.0033_1.txt",   "Fdyn_data8_3_0.0007_0.txt",   "Fdyn_data8_4_0.0021_0.txt",   "Fdyn_data8_5_0.0021_0.txt",   "Fdyn_data8_6_0.0033_0.txt",   
"Fdyn_data8_0_-0.0033_1.txt",  "Fdyn_data8_2_-0.0007_0.txt",  "Fdyn_data8_3_-0.0021_0.txt",  "Fdyn_data8_4_-0.0033_0.txt",  "Fdyn_data8_5_-0.0033_0.txt",  "Fdyn_data8_6_0.0033_1.txt",   
time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
                ...
                weight_quad_zmp1 = np.array([0.5, 0.5]) ##11
                weight_quad_cam = np.array([0.5, 0.5])#([weight_quad_camy] + [weight_quad_camx])
                weight_quad_upper = np.array([0.6, 0.6])
                weight_quad_com = np.array([5.0, 5.0, 1.0])#([weight_quad_comx] + [weight_quad_comy] + [weight_quad_comz])
                weight_quad_rf = np.array([3.0, 2.0, 5.0, 0.5, 0.5, 0.5])#np.array([weight_quad_rfx] + [weight_quad_rfy] + [weight_quad_rfz] + [weight_quad_rfroll] + [weight_quad_rfpitch] + [weight_quad_rfyaw])
                weight_quad_lf = np.array([3.0, 2.0, 5.0, 0.5, 0.5, 0.5])#np.array([weight_quad_lfx] + [weight_quad_lfy] + [weight_quad_lfz] + [weight_quad_lfroll] + [weight_quad_lfpitch] + [weight_quad_lfyaw])
                ...
                for i in range(0,N-1):
                    traj_[39] = (array_boundx_[i][0] + array_boundx_[i][1])/2 #zmp_refx_[i][0]
                    traj_[43] = (array_boundy_[i][0] + array_boundy_[i][1])/2#zmp_refy_[i][0]
                    ...
                    #pelvisBoundCost_vector[i] = crocoddyl.CostModelResidual(state_vector[i], crocoddyl.ActivationModelWeightedQuad(weight_quad_com), crocoddyl.ResidualModelCoMKinoPosition(state_vector[i], np.array([0.0, 0.0, data.com[0][2]]), actuation_vector[i].nu + 4))
                    ...
                    if array_boundy_[i][1] != 0.1425 or array_boundy_[i][0] != -0.1425:
                ...
                traj_[39] = (array_boundx_[N-1][0] + array_boundx_[N-1][1])/2 #zmp_refx_[i][0]
                traj_[43] = (array_boundy_[N-1][0] + array_boundy_[N-1][1])/2#zmp_refy_[i][0]
                ...
                #pelvisBoundCost_vector[N-1] = crocoddyl.CostModelResidual(state_vector[N-1], crocoddyl.ActivationModelWeightedQuad(weight_quad_com), crocoddyl.ResidualModelCoMKinoPosition(state_vector[N-1], np.array([0.0, 0.0, data.com[0][2]]), actuation_vector[N-1].nu + 4))
                ...
                while booltemp == True:
                    ...
                    if iter_ % 2 == 0:
                        ddp.th_stop = 0.0000000001
                        print("a")
                        if iter_ == 0:
                            #css = ddp.solve(xs, us, 3000, False)
                            c_start = time.time()
                            css = ddp.solve(xs, us, 100, False, 0.001)
                        ...
                        print("b")
                        if iter_ == 1:
                            css = ddp.solve(ddp.xs, ddp.us, 100, False)
                        else:
                            css = ddp.solve(ddp.xs, ddp.us, 100, False)
                    ...
                    if booltemp1 == False:
                        if iter_ >= 7 or abs(ddp.cost - cost_prev) < 0.0000001:
                            booltemp = False
                        cost_prev = ddp.cost
                        if iter_ == 0:
                            for key in crocs_data.keys():
                            ...
                            u_traj = np.array(ddp.us)[:,20:24]
                            acc_traj = np.array(ddp.us)[:, 0:20]
                            crocs_data['Right']['x_inputs'][e] =copy(ddp.xs[0][0:19])
                ...
                if time1 % 50 == 0:
                    filename = '/home/jhk/ssd_mount3/beforedata/ssp1/timestep=19/'
                    #filename1 = 'test1'
                    #filename2 = '.pkl'
                    filename3 = filename + k_1[kkkk]#+ filename1 + filename2

...
def loadmodel(kkkk):
    ...
    k_ = ["Fdyn_data8_8_0.0021_1.txt",
"Fdyn_data8_8_0.0021_0.txt",

"Fdyn_data8_8_0.0007_0.txt",

"Fdyn_data8_8_-0.0033_0.txt",

"Fdyn_data8_8_-0.0021_0.txt",

"Fdyn_data8_8_-0.0007_1.txt",
"Fdyn_data8_8_-0.0007_0.txt",

"Fdyn_data8_7_0.0033_0.txt",

"Fdyn_data8_7_0.0021_0.txt",

"Fdyn_data8_7_0.0007_1.txt",
"Fdyn_data8_7_0.0007_0.txt",

"Fdyn_data8_7_-0.0033_1.txt",
"Fdyn_data8_7_-0.0033_0.txt",

"Fdyn_data8_7_-0.0021_0.txt",

"Fdyn_data8_7_-0.0007_0.txt",

"Fdyn_data8_6_0.0033_2.txt",
"Fdyn_data8_6_0.0033_1.txt",
"Fdyn_data8_6_0.0033_0.txt",

"Fdyn_data8_6_0.0021_0.txt",


"Fdyn_data8_6_-0.0033_0.txt",

"Fdyn_data8_6_-0.0021_1.txt",
"Fdyn_data8_6_-0.0021_0.txt",

"Fdyn_data8_6_-0.0007_0.txt",




"Fdyn_data8_5_-0.0033_0.txt",

"Fdyn_data8_5_-0.0021_1.txt",
"Fdyn_data8_5_-0.0021_0.txt",





"Fdyn_data8_4_-0.0033_0.txt",


"Fdyn_data8_4_-0.0007_1.txt",
"Fdyn_data8_4_-0.0007_0.txt",


"Fdyn_data8_3_0.0021_0.txt",


"Fdyn_data8_3_-0.0033_0.txt",

"Fdyn_data8_3_-0.0021_0.txt",


"Fdyn_data8_2_0.0033_0.txt",





"Fdyn_data8_2_-0.0007_0.txt",

"Fdyn_data8_1_0.0033_0.txt",

"Fdyn_data8_1_0.0021_1.txt",
"Fdyn_data8_1_0.0021_0.txt",

"Fdyn_data8_1_0.0007_1.txt",
"Fdyn_data8_1_0.0007_0.txt",

"Fdyn_data8_1_-0.0033_0.txt",

"Fdyn_data8_1_-0.0021_0.txt",


"Fdyn_data8_0_0.0033_1.txt",
"Fdyn_data8_0_0.0033_0.txt",

"Fdyn_data8_0_0.0021_1.txt",
"Fdyn_data8_0_0.0021_0.txt",


"Fdyn_data8_0_-0.0033_1.txt",
"Fdyn_data8_0_-0.0033_0.txt",]
            
    k_1 = [

"filename8_8_0.0021_1.txt",
"filename8_8_0.0021_0.txt",

"filename8_8_0.0007_0.txt",

"filename8_8_-0.0033_0.txt",

"filename8_8_-0.0021_0.txt",

"filename8_8_-0.0007_1.txt",
"filename8_8_-0.0007_0.txt",

"filename8_7_0.0033_0.txt",

"filename8_7_0.0021_0.txt",

"filename8_7_0.0007_1.txt",
"filename8_7_0.0007_0.txt",

"filename8_7_-0.0033_1.txt",
"filename8_7_-0.0033_0.txt",

"filename8_7_-0.0021_0.txt",

"filename8_7_-0.0007_0.txt",

"filename8_6_0.0033_2.txt",
"filename8_6_0.0033_1.txt",
"filename8_6_0.0033_0.txt",

"filename8_6_0.0021_0.txt",


"filename8_6_-0.0033_0.txt",

"filename8_6_-0.0021_1.txt",
"filename8_6_-0.0021_0.txt",

"filename8_6_-0.0007_0.txt",




"filename8_5_-0.0033_0.txt",

"filename8_5_-0.0021_1.txt",
"filename8_5_-0.0021_0.txt",





"filename8_4_-0.0033_0.txt",


"filename8_4_-0.0007_1.txt",
"filename8_4_-0.0007_0.txt",


"filename8_3_0.0021_0.txt",


"filename8_3_-0.0033_0.txt",

"filename8_3_-0.0021_0.txt",


"filename8_2_0.0033_0.txt",





"filename8_2_-0.0007_0.txt",

"filename8_1_0.0033_0.txt",

"filename8_1_0.0021_1.txt",
"filename8_1_0.0021_0.txt",

"filename8_1_0.0007_1.txt",
"filename8_1_0.0007_0.txt",

"filename8_1_-0.0033_0.txt",

"filename8_1_-0.0021_0.txt",


"filename8_0_0.0033_1.txt",
"filename8_0_0.0033_0.txt",

"filename8_0_0.0021_1.txt",
"filename8_0_0.0021_0.txt",


"filename8_0_-0.0033_1.txt",
"filename8_0_-0.0033_0.txt",

]
    filename = '/home/jhk/walkingdata/beforedata/ssp2/file/' #filename + filename1 + filename2
    filename3 = filename + 'timestep=3_finish_re0'
    print(filename3)
    ...
    filename = '/home/jhk/ssd_mount3/beforedata/ssp1/timestep=37/' #filename + filename1 + filename2
    filename3 = filename + 'filename8_2_4_0.0021_0.txt'
    print(filename3)
    with open(filename3, 'rb') as f:
        database = pickle.load(f,  encoding='iso-8859-1')
    f.close()
    ...
    filename3 = filename + k_1[len(k_)-1]#'filename3_5_11.pkl'
    with open(filename3, 'rb') as f:
        database = pickle.load(f,  encoding='iso-8859-1')
    f.close()
    database1 = database
    ...
    print(database1['Right']['trajs'][0][0][0:2])
    print(database1['Right']['x_state'][0][59])
    print(database1['Right']['trajs'][0][59][0:2])
    print("1000")
    print(database1['Right']['x_state'][1000][0])
    print(database1['Right']['trajs'][1000][0][0:2])
    print(database1['Right']['x_state'][1000][59])
    print(database1['Right']['trajs'][1000][59][0:2])
    print("2000")
    print(database1['Right']['x_state'][2000][0])
    print(database1['Right']['trajs'][2000][0][0:2])
    print(database1['Right']['x_state'][2000][59])
    print(database1['Right']['trajs'][2000][59][0:2])
    print("3000")
    print(database1['Right']['x_state'][3000][0])
    print(database1['Right']['trajs'][3000][0][0:2])
    print(database1['Right']['x_state'][3000][59])
    print(database1['Right']['trajs'][3000][59][0:2])
    print("4000")
    print(database1['Right']['x_state'][4000][0])
    print(database1['Right']['trajs'][4000][0][0:2])
    print(database1['Right']['x_state'][4000][59])
    print(database1['Right']['trajs'][4000][59][0:2])
...
def talker():
    ...
    for kkkk in range(4,300,5):
        ...
        N = 60
        k = 1
        f = open("/home/jhk/walkingdata/beforedata/ssp1/timestep=28_finish/lfoot1_ssp1_1.txt", 'r')
        f1 = open("/home/jhk/walkingdata/beforedata/ssp1/timestep=28_finish/rfoot1_ssp1_1.txt", 'r')
        lines1 = f1.readlines()
        lines = f.readlines()
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            '''
            if time1 % 200 == 0:
                filename3 = '/home/jhk/walkingdata/beforedata/ssp1/timestep=28_finish/Fdyn_data5_8_7.txt' #filename + filename1 + filename2
                with open(filename3,'wb') as f:
                    pickle.dump(database1,f)
            '''
        k_ = ["Fdyn_data8_0_-0.0007_0.txt",  "Fdyn_data8_1_-0.0007_0.txt",  "Fdyn_data8_2_-0.0007_2.txt",  "Fdyn_data8_3_0.0033_6.txt",   "Fdyn_data8_7_0.0033_5.txt",
"Fdyn_data8_0_0.0007_0.txt",   "Fdyn_data8_1_0.0007_0.txt",   "Fdyn_data8_2_-0.0021_0.txt",  "Fdyn_data8_6_-0.0007_0.txt",  "Fdyn_data8_7_0.0033_6.txt",
"Fdyn_data8_0_-0.0007_1.txt",  "Fdyn_data8_1_-0.0007_1.txt",  "Fdyn_data8_2_0.0021_0.txt",   "Fdyn_data8_6_-0.0007_1.txt",  "Fdyn_data8_7_0.0033_7.txt",
"Fdyn_data8_0_0.0007_1.txt",   "Fdyn_data8_1_0.0007_1.txt",   "Fdyn_data8_2_0.0021_1.txt",   "Fdyn_data8_6_-0.0007_2.txt",  "Fdyn_data8_7_0.0033_8.txt",
"Fdyn_data8_0_-0.0007_2.txt",  "Fdyn_data8_1_-0.0007_2.txt",  "Fdyn_data8_2_0.0021_2.txt",   "Fdyn_data8_6_-0.0007_3.txt",  "Fdyn_data8_7_0.0033_9.txt",
"Fdyn_data8_0_-0.0021_0.txt",  "Fdyn_data8_1_0.0007_2.txt",   "Fdyn_data8_2_0.0021_3.txt",   "Fdyn_data8_6_-0.0021_0.txt",  "Fdyn_data8_8_-0.0007_0.txt",
"Fdyn_data8_0_0.0021_0.txt",   "Fdyn_data8_1_-0.0007_3.txt",  "Fdyn_data8_2_-0.0033_0.txt",  "Fdyn_data8_6_-0.0021_1.txt",  "Fdyn_data8_8_0.0007_0.txt",
"Fdyn_data8_0_-0.0021_1.txt",  "Fdyn_data8_1_0.0007_3.txt",   "Fdyn_data8_2_0.0033_0.txt",   "Fdyn_data8_6_-0.0021_2.txt",  "Fdyn_data8_8_0.0007_1.txt",
"Fdyn_data8_0_0.0021_1.txt",   "Fdyn_data8_1_0.0007_4.txt",   "Fdyn_data8_2_-0.0033_1.txt",  "Fdyn_data8_6_-0.0033_0.txt",  "Fdyn_data8_8_0.0007_2.txt",
"Fdyn_data8_0_-0.0021_2.txt",  "Fdyn_data8_1_0.0007_5.txt",   "Fdyn_data8_2_0.0033_1.txt",   "Fdyn_data8_6_-0.0033_1.txt",  "Fdyn_data8_8_0.0007_3.txt",
"Fdyn_data8_0_0.0021_2.txt",   "Fdyn_data8_1_0.0007_6.txt",   "Fdyn_data8_2_0.0033_2.txt",   "Fdyn_data8_6_-0.0033_2.txt",  "Fdyn_data8_7_-0.0033_2.txt",
"Fdyn_data8_0_-0.0021_3.txt",  "Fdyn_data8_1_-0.0021_0.txt",  "Fdyn_data8_2_0.0033_3.txt",   "Fdyn_data8_6_-0.0033_3.txt",  "Fdyn_data8_8_0.0021_0.txt",
"Fdyn_data8_0_0.0021_3.txt",   "Fdyn_data8_1_0.0021_0.txt",   "Fdyn_data8_3_-0.0007_0.txt",  "Fdyn_data8_6_-0.0033_4.txt",  "Fdyn_data8_8_0.0021_1.txt",
"Fdyn_data8_0_-0.0021_4.txt",  "Fdyn_data8_1_0.0021_1.txt",   "Fdyn_data8_3_0.0007_0.txt",   "Fdyn_data8_6_-0.0033_5.txt",  "Fdyn_data8_7_-0.0033_2.txt",
"Fdyn_data8_0_0.0021_4.txt",   "Fdyn_data8_1_0.0021_2.txt",   "Fdyn_data8_3_-0.0007_1.txt",  "Fdyn_data8_7_-0.0007_0.txt",  "Fdyn_data8_8_0.0021_3.txt",
"Fdyn_data8_0_0.0021_5.txt",   "Fdyn_data8_1_0.0021_3.txt",   "Fdyn_data8_3_0.0007_1.txt",   "Fdyn_data8_7_0.0007_0.txt",   "Fdyn_data8_8_0.0021_4.txt",
"Fdyn_data8_0_0.0021_6.txt",   "Fdyn_data8_1_0.0021_4.txt",   "Fdyn_data8_3_0.0007_2.txt",   "Fdyn_data8_7_-0.0007_1.txt",  "Fdyn_data8_8_0.0021_5.txt",
"Fdyn_data8_0_0.0021_7.txt",   "Fdyn_data8_1_-0.0033_0.txt",  "Fdyn_data8_3_-0.0021_0.txt",  "Fdyn_data8_7_-0.0007_2.txt",  "Fdyn_data8_8_-0.0033_0.txt",
"Fdyn_data8_0_-0.0033_0.txt",  "Fdyn_data8_1_0.0033_0.txt",   "Fdyn_data8_3_0.0021_0.txt",   "Fdyn_data8_7_-0.0021_0.txt",  "Fdyn_data8_7_-0.0033_2.txt",
"Fdyn_data8_0_0.0033_0.txt",   "Fdyn_data8_1_-0.0033_1.txt",  "Fdyn_data8_3_-0.0021_1.txt",  "Fdyn_data8_7_0.0021_0.txt",   "Fdyn_data8_8_0.0033_10.txt",
"Fdyn_data8_0_-0.0033_1.txt",  "Fdyn_data8_1_0.0033_1.txt",   "Fdyn_data8_3_0.0021_1.txt",   "Fdyn_data8_7_-0.0021_1.txt",  "Fdyn_data8_8_-0.0033_1.txt",
"Fdyn_data8_0_0.0033_1.txt",   "Fdyn_data8_1_-0.0033_2.txt",  "Fdyn_data8_3_-0.0021_2.txt",  "Fdyn_data8_7_0.0021_1.txt",   "Fdyn_data8_8_0.0033_1.txt",
"Fdyn_data8_0_-0.0033_2.txt",  "Fdyn_data8_1_0.0033_2.txt",   "Fdyn_data8_3_0.0021_2.txt",   "Fdyn_data8_7_0.0021_2.txt",   "Fdyn_data8_8_-0.0033_2.txt",
"Fdyn_data8_0_0.0033_2.txt",   "Fdyn_data8_1_-0.0033_3.txt",  "Fdyn_data8_3_0.0021_3.txt",   "Fdyn_data8_7_-0.0033_0.txt",  "Fdyn_data8_8_0.0033_2.txt",
"Fdyn_data8_0_-0.0033_3.txt",  "Fdyn_data8_1_0.0033_3.txt",   "Fdyn_data8_3_-0.0033_0.txt",  "Fdyn_data8_7_0.0033_0.txt",   "Fdyn_data8_8_0.0033_3.txt",
"Fdyn_data8_0_0.0033_3.txt",   "Fdyn_data8_1_0.0033_4.txt",   "Fdyn_data8_3_0.0033_0.txt",   "Fdyn_data8_7_-0.0033_1.txt",  "Fdyn_data8_8_0.0033_4.txt",
"Fdyn_data8_0_0.0033_4.txt",   "Fdyn_data8_1_0.0033_5.txt",   "Fdyn_data8_3_0.0033_1.txt",   "Fdyn_data8_7_0.0033_1.txt",   "Fdyn_data8_8_0.0033_5.txt",
"Fdyn_data8_0_0.0033_5.txt",   "Fdyn_data8_2_-0.0007_0.txt",  "Fdyn_data8_3_0.0033_2.txt",   "Fdyn_data8_7_-0.0033_2.txt",  "Fdyn_data8_8_0.0033_6.txt",
"Fdyn_data8_0_0.0033_6.txt",   "Fdyn_data8_2_0.0007_0.txt",   "Fdyn_data8_3_0.0033_3.txt",   "Fdyn_data8_7_0.0033_2.txt",   "Fdyn_data8_8_0.0033_7.txt",
"Fdyn_data8_0_0.0033_7.txt",   "Fdyn_data8_2_-0.0007_1.txt",  "Fdyn_data8_3_0.0033_4.txt",   "Fdyn_data8_7_-0.0033_2.txt",   "Fdyn_data8_8_0.0033_8.txt",
"Fdyn_data8_0_0.0033_8.txt",   "Fdyn_data8_2_0.0007_1.txt",   "Fdyn_data8_3_0.0033_5.txt",   "Fdyn_data8_7_0.0033_4.txt",   "Fdyn_data8_8_0.0033_9.txt",
]
        filename = '/home/jhk/ssd_mount2/beforedata/ssp2/timestep=28_finish12/' #filename + filename1 + filename2
        filename3 = filename + 'filename3_5_32.pkl'
        with open(filename3,'wb') as f:
            pickle.dump(database1,f)
        '''    

...
"timestep=48_finish_",
    ...
    if learn_type1 == 0:
        ...
        file_name = '/home/jhk/kino_dynamic_learning/dataset/dataset2/fdyn/'
        file_name2 = 'w_trajs_pca_EarlyState_'
        file_name3 = '.pkl'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        pickle.dump(pca, open(file_name4,"wb"))
        file_name2 = 'w_vel_trajs_pca_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        pickle.dump(pca_vel, open(file_name4,"wb"))
        file_name2 = 'w_x_trajs_pca_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        ...
        file_name = '/home/jhk/kino_dynamic_learning/dataset/dataset2/fdyn/'
        file_name2 = 'x_inputs_train_EarlyState_'
        file_name3 = '.pt'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(x_inputs_train, file_name4)
        file_name2 = 'x_inputs_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(x_inputs_test, file_name4)
        file_name2 = 'y_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_test, file_name4)
        file_name2 = 'y_vel_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_vel_test, file_name4)
        file_name2 = 'y_u_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_u_test, file_name4)
        file_name2 = 'y_acc_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_acc_test, file_name4)
        file_name2 = 'y_x_test_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_x_test, file_name4)
        file_name2 = 'y_train_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_train, file_name4)
        file_name2 = 'y_vel_train_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_vel_train, file_name4)
        file_name2 = 'y_u_train_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_u_train, file_name4)
        file_name2 = 'y_acc_train_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
        torch.save(y_acc_train, file_name4)
        file_name2 = 'y_x_train_EarlyState_'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3
...
def talker():
    ...
    for i in range(27, 49, 1):#learning_data_num):
        PCAlearning(i)
    k = adsfasdff
    print("start")

...
"timestep=29_finish"
    ...
    for kk in range(0, len(array_),1):
        ...
        filename2 = filename + array_[kk] + '/' + array_[kk] + '_re_add'
                ...
                for k in range(1,50):
                    for f in range(50, 56):
                        ...
                        for jj in JJ:
                            ...
                            if k3 == 200:
                                if(cost < cost_temp):
                                    k2 = [i, j, k, f, cost/200.0, traj_cost, vel_cost, x_cost]
                                    cost_temp = cost
                print(k2)
                print(array_[kk])
            print("jj= " + str(jj))
        ...
        '''
        with open("/home/jhk/ssd_mount3/beforedata/ssp1/timestep=12_finish/output11.txt", "w") as txt_file:
            for line in best:

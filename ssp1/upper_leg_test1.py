...
def talker():
    ...
    k_ = ["timestep=31_finish32_", "timestep=31_finish35_",  "timestep=31_finish38_",
"timestep=31_finish30_", "timestep=31_finish33_",  "timestep=31_finish36_",  "timestep=31_finish39_",
"timestep=31_finish31_",  "timestep=31_finish34_",  "timestep=31_finish37_",   
    ]

    k_1 = ["timestep=31_finish32_final", "timestep=31_finish35_final",  "timestep=31_finish38_final",
"timestep=31_finish30_final", "timestep=31_finish33_final",  "timestep=31_finish36_final",  "timestep=31_finish39_final",
"timestep=31_finish31_final",  "timestep=31_finish34_final",  "timestep=31_finish37_final", 
]

    for kkkk in range(1,len(k_),3):
        modelInitialize()
        walkingSetup()
        footStep()
        cpGenerator()
        ...
        f3 = open("/home/jhk/ssd_mount3/beforedata/ssp1/newfile.txt", 'w')
        f1 = open("/home/jhk/ssd_mount3/beforedata/ssp1/newfile1.txt", 'w')
        f2 = open("/home/jhk/ssd_mount3/beforedata/ssp1/newfile2.txt", 'w')
        zmpx = []
        zmpy = []
        #print(zmp_refx)
        ...
        timestep=31
        filename = '/home/jhk/ssd_mount3/beforedata/ssp1/'
        filename2 = k_[kkkk]
        ...
        f = open("/home/jhk/ssd_mount3/beforedata/ssp1/lfoot1.txt", 'r')
        f1 = open("/home/jhk/ssd_mount3/beforedata/ssp1/rfoot2.txt", 'r')
        lines1 = f1.readlines()
        lines = f.readlines()
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            print( database['Right']['trajs'][time1][0])
            '''
            #filename = '/home/jhk/ssd_mount3/beforedata/ssp2_final2/real/i='
            #filename1 = str(kkkk)
            #filename2 = '/ssp1_data7.txt'
            '''
            if time1 % 200 == 0:
                filename3 = '/home/jhk/ssd_mount3/beforedata/ssp1/timestep=23/ssp1_data5_8_02_0.0007.txt' #filename + filename1 + filename2

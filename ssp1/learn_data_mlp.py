...
"timestep=12_finish",      "timestep=17_finish",      "timestep=21_finish",      "timestep=26_finish",      "timestep=30_finish",      "timestep=39_finish",
"timestep=13_finish",       "timestep=22_finish",      "timestep=27_finish",      "timestep=31_finish",      "timestep=40_finish",
"timestep=15_finish",      "timestep=19_finish",       "timestep=28_finish",      "timestep=33_finish",      
"timestep=16_finish",      "timestep=20_finish",      "timestep=24_finish",      "timestep=29_finish",      "timestep=38_finish",      
]


    param = [
        #[2, 1, 19, 49], [1, 1, 11, 49], [1, 1, 5, 49], [1, 1, 3, 48], [2, 1, 5, 49], [2, 1, 17, 49], [1, 1, 7, 49], [2, 1, 13, 55], [2, 1, 7, 49],
     #[1, 1, 13, 50],  
     #[2, 1, 13, 53], 
     #[1, 1, 15, 49],
     #[1, 1, 19, 47], 
...
"timestep=16_finish_re_add",      "timestep=20_finish_re_add",      "timestep=24_finish_re_add",      "timestep=29_finish_re_add",      "timestep=38_finish_re_add",  
    ...
    file_name2 = "/timestep="
    file_name3 = file_name +naming[time_step]+'/'+param[time_step]#+'_re'
    print(file_name3)
    ...
    for key in keys:
        x_inputs_train_ae[key], x_inputs_test_ae[key], y_train_ae[key], y_test_ae[key] = train_test_split(x_inputs[key], trajs[key], test_size = 0.0001, random_state=1)
        _,_, y_vel_train_ae[key], y_vel_test_ae[key] = train_test_split(x_inputs[key],vel_trajs[key], test_size = 0.0001, random_state=1)
        ...
        _,_, y_x_train_ae[key], y_x_test_ae[key] = train_test_split(x_inputs[key],x_trajs[key], test_size = 0.0001, random_state=1)
    ...
    if learn_type == 0:
        ...
        file_name = '/home/jhk/ssd_mount/beforedata/ssp1/mlp'
        file_name2 = '0_'
        file_name3 = '.pkl'
        ...
        loss_graph[2] = loss.item()


        best = np.array(loss_graph)
        file_name = "/home/jhk/ssd_mount3/beforedata/ssp1/"
        file_name3 = file_name +naming[time_step]+'/'+'mlp_loss.txt'
...
def talker():
    ...
    for i in range(0, 49):#learning_data_num):
        PCAlearning(i)
    k = adsfasdff
    print("start")

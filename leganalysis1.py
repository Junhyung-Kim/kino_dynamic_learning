...
def loadmodel():
    ...
    with open('/home/jhk/ssd_mount/beforedata/ssp/i=1-3,10,10,10/Fdyn_data5.txt', 'rb') as f:
...
def talker():
    ...
    for time1 in range(0, len(database1['Right']['vel_trajs'])):
        ...
        print("i")
        print(time1)
        print(database['Right']['trajs'][time1][N-1])
        print(database['Right']['trajs'][time1][0])
        print("ccc")
        
        with open('/home/jhk/ssd_mount/beforedata/ssp/i=1-3,10,10,10/Fdyn_data7.txt','wb') as f:

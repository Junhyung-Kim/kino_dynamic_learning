...
def talker():
    ...
    for kkkk in range(0,1):
        ...
        f3 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=19/newfile.txt", 'w')
        f1 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=19/newfile1.txt", 'w')
        f2 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=19/newfile2.txt", 'w')
        zmpx = []
        zmpy = []
        #print(zmp_refx)
        ...
        N = 60
        k = 1
        f = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=19/lfoot1_ssp1_1.txt", 'r')
        f1 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=19/rfoot1_ssp1_1.txt", 'r')
        lines1 = f1.readlines()
        lines = f.readlines()
        ...
        for time1 in range(0, 1):#len(database1['Right']['vel_trajs'])):
            ...
            for i in range(1, N):
                if LIPM_bool == 1:
                    ...
                    com_refd = np.array([ comrefdx- 0.0*(data.com[0][0] - comrefx), comrefdy- 0.0*(data.com[0][1] - comrefy), 0.0])

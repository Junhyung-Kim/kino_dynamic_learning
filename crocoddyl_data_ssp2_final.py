...
def talker():
    ...
    for step_time in range(0, 2):
        ...
        #ilename1 = str('/')
        filename2 = '/i=1,4/Fdyn_data7.txt'
        ...
        e = 0
        for time1 in range(0,1000):# len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                iter_ = iter_ + 1
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp2_final/i=1,4/filename3_1000_'

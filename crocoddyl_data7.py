...
def talker():
    ...
    for time_step in range(49, 50):
        ...
        e = 0
        for time1 in range(9001,  len(database_['Right']['u_trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        print("c")
                        print(time1)
                        css = ddp.solve(xs, us, 10000, False, 0.0008)
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 10000, False, 0.0008)
                c_end = time.time()

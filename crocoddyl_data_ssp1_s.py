...
def talker():
    ...
    for step_time in range(0, 1):
        ...
        e = 0
        for time1 in range(len(database_['Right']['trajs'])-1, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 10000, False, 0.001)
                ...
                iter_ = iter_ + 1
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp1/i=3/filename4_'

...
def talker():
    ...
    for step_time in range(0, 1):
        ...
        filename = '/home/jhk/ssd_mount/beforedata/ssp1/dist/time_step=0/-0.004'
        #ilename1 = str('/')
        filename2 = '/Fdyn_data7_9_-0.004.txt'
        ...
        for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            ddp = crocoddyl.SolverDDP(problemWithRK4)
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 5000, False, 0.001)
                        #problemWithRK4.calc(xs,us) #3.33, 0.88
                        #problemWithRK4.calcDiff(xs,us)
                        c_end = time.time()
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 1000, False, 0.01)
            ...
            '''
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp1/dist/time_step=0/-0.004/filename3_9_'

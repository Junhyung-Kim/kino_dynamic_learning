...
def talker():
    ...
    for step_time in range(0, 2):
        f = open("/home/jhk/ssd_mount/beforedata/ssp1/timestep=49/lfoot1_ssp1_1.txt", 'r')
        f1 = open("/home/jhk/ssd_mount/beforedata/ssp1/timestep=49/rfoot1_ssp1_1.txt", 'r')
        f2 = open("/home/jhk/ssd_mount/beforedata/ssp1/timestep=48/zmp2_ssp1_1.txt", 'r')
        ...
        filename3 = '/home/jhk/ssd_mount/beforedata/ssp1/Fdyn_data7_test.txt'
        ...
        for time1 in range(0, 1):#len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 10000, False, 0.01)
            ...
            '''
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp2_final/i=10/filename3_'
        ...
        filename = '/home/jhk/ssd_mount/beforedata/ssp1/filename3_'
        filename1 = 'test'
        filename2 = '.pkl'
        filename3 = filename + filename1 + filename2
        with open(filename3, 'wb') as f:

...
def PCAlearning():
    ...
    with open('/home/jhk/ssd_mount/beforedata/ssp2/i=9,j=2,1,9/Fdyn_data7.txt', 'rb') as f:
...
def talker():
    ...
    print("start")
    for step_time in range(32,50):
        f = open("/home/jhk/ssd_mount/lfoot1 (copy).txt", 'r')
        f1 = open("/home/jhk/ssd_mount/rfoot1 (copy).txt", 'r')
        f2 = open("/home/jhk/ssd_mount/zmp2 (copy).txt", 'r')
        f3 = open("/home/jhk/data/mpc/5_tocabi_data.txt", 'w')
        f4 = open("/home/jhk/data/mpc/6_tocabi_data.txt", 'w')
        f5 = open("/home/jhk/ssd_mount/zmp3.txt", 'r')
        ...
        filename = '/home/jhk/ssd_mount/beforedata/ssp2/integral'
        #ilename1 = str('/')
        filename2 = '/Fdyn_data7_4_FULL.txt'
        filename3 = filename  + filename2
        #with open('/home/jhk/ssd_mount/Fdyn_data7.txt', 'rb') as f:
        with open(filename3, 'rb') as f:
            database = pickle.load(f,  encoding='iso-8859-1')
        f.close()
        print(len(database[key]['trajs'][0]))
        ...
        for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                booltemp1 = True
                if iter_ % 2 == 0:
                    ddp.th_stop = 0.00000009
                    print("a")
                    if iter_ == 0:
                        c_start = time.time()
                        css = ddp.solve(xs, us, 10000, False, 0.005)
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 10000, False, 0.005)
            ...
            if time1 % 500 == 0:
                filename = '/home/jhk/ssd_mount/beforedata/ssp2/integral/filename3_6_'

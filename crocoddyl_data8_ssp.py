...
def PCAlearning():
    ...
    with open('/home/jhk/ssd_mount/beforedata/ssp2/i=9,j=11/Fdyn_data7.txt', 'rb') as f:
    ...
    for time1 in range(0, len(database_['Right']['u_trajs'])):#15, len(database_['Right']['trajs'])):
        ...
        while booltemp == True:
            ...
            if booltemp1 == False:
                ...
                with open('/home/jhk/ssd_mount/beforedata/ssp2/i=9,j=11/filename3.pkl', 'wb') as f:

...
def PCAlearning(time_step):
    ...
    file_name = '/home/jhk/ssd_mount/beforedata/ssp2/timestep='
    file_name2 = '/filename3_5_0.pkl'
    ...
    if learn_type1 == 0:
        ...
        file_name = '/home/jhk/kino_dynamic_learning/dataset/'
...
def talker():
    ...
    for i in range(0, learning_data_num):
        PCAlearning(i)

...
def loadmodel(kkkk):
    ...
    filename = '/home/jhk/ssd_mount/beforedata/ssp1/i='
    filename1 = '3'#str(kkkk)
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            for i in range(1, N):
                if LIPM_bool == 1:
                    ...
                    hg = [database['Right']['x_state'][time1][i][7]- 0.03*(data.hg.angular[0] - database['Right']['x_state'][time1][i][7]), database['Right']['x_state'][time1][i][3]- 0.03*(data.hg.angular[1] - database['Right']['x_state'][time1][i][3])]
            ...
            if time1 % 200 == 0:
                filename3 = '/home/jhk/ssd_mount/beforedata/ssp1/i=5/Fdyn_data8.txt' #filename + filename1 + filename2

            ...
            for k in range(1,50):
                for f in range(32,37):
                    ...
                    for num in range(0, 60):
                        ...
                        if num  == 0:
                            cost = np.linalg.norm(trajs[key][10000][num] - np.dot(Phi[num], aa_)) *np.linalg.norm(trajs[key][10000][num] - np.dot(Phi[num], aa_)) + np.linalg.norm(x_trajs[key][10000][num] - np.dot(Phi[num], ee_)) *np.linalg.norm(x_trajs[key][10000][num] - np.dot(Phi[num], ee_)) + np.linalg.norm(vel_trajs[key][10000][num] - np.dot(Phi[num], bb_)) * np.linalg.norm(vel_trajs[key][10000][num] - np.dot(Phi[num], bb_))
                            ...
                            cost = cost + np.linalg.norm(trajs[key][10000][num] - np.dot(Phi[num], aa_)) *np.linalg.norm(trajs[key][10000][num] - np.dot(Phi[num], aa_)) + np.linalg.norm(x_trajs[key][10000][num] - np.dot(Phi[num], ee_)) *np.linalg.norm(x_trajs[key][10000][num] - np.dot(Phi[num], ee_)) + np.linalg.norm(vel_trajs[key][10000][num] - np.dot(Phi[num], bb_)) * np.linalg.norm(vel_trajs[key][10000][num] - np.dot(Phi[num], bb_))
                    ...
                    if i  == 1 and j == 1 and k == 1 and f ==32:
                        cost_temp = cost
                        k2 = [i, j, k, f, cost]
                        print("start")
                    if(cost < cost_temp):

...
def loadmodel(kkkk):
    ...
    for key in database1.keys():
        ...
        database1[key]['costs'] = [] 
        database1[key]['iters'] = []
    #beforedata/ssp1/dist/time_step=0/-0.004/
    filename = '/home/jhk/ssd_mount/beforedata/ssp1/dist/time_step='
    filename1 = '0'#str(kkkk)
    filename2 = '/-0.004/Fdyn_data5_9_-0.004.txt'
...
def talker():
    ...
    for kkkk in range(0,1):
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            #filename = '/home/jhk/ssd_mount/beforedata/ssp12/real/i='
            #filename1 = str(kkkk)
            #filename2 = '/Fdyn_data7.txt'
            
            if time1 % 200 == 0:
                filename3 = '/home/jhk/ssd_mount/beforedata/ssp1/dist/time_step=0/-0.004/Fdyn_data7_9_-0.004.txt' #filename + filename1 + filename2

...
def talker():
    ...
    for time1 in range(0, 40):#(35, len(database_['Right']['u_trajs'])):#15, len(database_['Right']['trajs'])):
        ...
        while booltemp == True:
            ...
            if booltemp1 == False:
                ...
                with open('/home/jhk/ssd_mount/afterprocessing/3/filename2.pkl', 'wb') as f:

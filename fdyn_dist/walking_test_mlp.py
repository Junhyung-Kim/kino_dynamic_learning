...
"timestep=48_finish",
    ...
    file_name = '/home/jhk/ssd_mount/beforedata/fdyn/mlpEarly' 
    file_name2 = '0_'
    file_name3 = '.pkl'
...
def talker():
    ...
    for time_step in range(1, total_time):
        ...
        weight_quad_zmp1 = np.array([0.01, 0.01]) ##11
        ...
        weight_quad_rf = np.array([100.0, 10.0, 50.0, 0.5, 0.5, 0.5])#np.array([weight_quad_rfx] + [weight_quad_rfy] + [weight_quad_rfz] + [weight_quad_rfroll] + [weight_quad_rfpitch] + [weight_quad_rfyaw])
        weight_quad_lf = np.array([100.0, 10.0, 50.0, 0.5, 0.5, 0.5])#np.array([weight_quad_lfx] + [weight_quad_lfy] + [weight_quad_lfz] + [weight_quad_lfroll] + [weight_quad_lfpitch] + [weight_quad_lfyaw])

...
def talker():
    ...
    for step_time in range(0, 1):
        ...
        f2 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=47/zmp2_ssp1_1.txt", 'r')
        ...
        for kkkk in range(2, 500, 3):
            ...
            k_ = ["Fdyn_data5_8_62_0.0033_0.txt",
"Fdyn_data5_8_63_-0.0021_0.txt",
"Fdyn_data5_8_63_-0.0033_0.txt",
]
            
            k_1 = ["filename5_8_62_0.0033_0.txt",
"filename5_8_63_-0.0021_0.txt",
"filename5_8_63_-0.0033_0.txt",
]
            
            
            filename = '/home/jhk/walkingdata/beforedata/fdyn/timestep=47_more/'#'/home/jhk/walkingdata/beforedata/fdyn_int/timestep=47/'
            ...
            for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
                ...
                if time1 % 50 == 0:
                    filename = '/home/jhk/walkingdata/beforedata/fdyn/timestep=47_more/'
                    #filename1 = 'test1'
                    #filename2 = '.pkl'

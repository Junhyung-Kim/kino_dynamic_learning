...
def talker():
    ...
    print("start")
    f = open("/home/jhk/walkingdata/beforedata/fdyn/timestep=5/lfoot2_final.txt", 'r')
    f1 = open("/home/jhk/walkingdata/beforedata/fdyn/timestep=5/rfoot2_final.txt", 'r')
    f2 = open("/home/jhk/walkingdata/beforedata/fdyn/timestep=5/zmp2_ssp1_1.txt", 'r')
    ...
    with open('/home/jhk/walkingdata/beforedata/fdyn/timestep=5/filename5_9_62_-0.0021_2.txt', 'rb') as f:

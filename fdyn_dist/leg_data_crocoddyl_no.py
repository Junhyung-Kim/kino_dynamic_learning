...
def talker():
    ...
    for step_time in range(0, 1):
        ...
        filename3 = '/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=47/Fdyn_data5_8_62_-0.0007.txt'
        ...
        for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    if iter_ == 0:
                        ...
                        c_start = time.time()
                        css = ddp.solve(xs, us, 100, False, 0.01)
                        #problemWithRK4.calc(xs,us) #3.33, 0.88
                        #problemWithRK4.calcDiff(xs,us)
                        c_end = time.time()
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 100, False, 0.01)
            ...
            if time1 % 5 == 0:
                filename = '/home/jhk/ssd_mount2/beforedata/fdyn_int/crocoddyl/timestep=47/filename3_62_-0.0007.pkl'
                #filename1 = 'test1'
                #filename2 = '.pkl'

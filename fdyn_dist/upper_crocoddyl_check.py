...
def talker():
    ...
    #with open('/home/jhk/walkingdata/beforedata/fdyn/afterdata/integral/filename4.pkl', 'rb') as f:
    with open('/home/jhk/ssd_mount/filename3.pkl', 'rb') as f:
    #with open('/home/jhk/walkingdata/beforedata/fdyn/Fdyn_data6.txt', 'rb') as f:
    #file_name ='/home/jhk/walkingdata/beforedata/fdyn/filenametest_'
    #file_name2 = '.pkl'
    ...
    #with open('/home/jhk/walkingdata/beforedata/fdyn/afterdata/integral/filename4.pkl', 'rb') as f:
    #//ho11me/jhk/walkingdata/beforedata/fdyn/beforeprocessing/SSP/i=0-8,j=13/timestep=45_finish/timestep=45_finish
    #with open('/home/jhk/walkingdata/beforedata/fdyn/beforedata/integrate_fdyn/filename3_40_-6775.pkl', 'rb') as f:
    ...
    for i in range(0, N-1):
        ...
        #print([array_boundRF_[i], array_boundLF_[i]])

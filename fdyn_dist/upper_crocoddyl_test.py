...
def talker():
    ...
    for step_time in range(15,16):
        ...
        for kkkk in range(0, 500, 8):
            ...
            k_ = ["timestep=15_finish_0_",
"timestep=15_finish_1_",
"timestep=15_finish_10_",
"timestep=15_finish_11_",
"timestep=15_finish_12_",
"timestep=15_finish_13_",
"timestep=15_finish_14_",
"timestep=15_finish_15_",
"timestep=15_finish_16_",
"timestep=15_finish_17_",
"timestep=15_finish_18_",
"timestep=15_finish_19_",
"timestep=15_finish_2_",
"timestep=15_finish_20_",
"timestep=15_finish_21_",
"timestep=15_finish_22_",
"timestep=15_finish_23_",
"timestep=15_finish_24_",
"timestep=15_finish_25_",
"timestep=15_finish_26_",
"timestep=15_finish_27_",
"timestep=15_finish_28_",
"timestep=15_finish_29_",
"timestep=15_finish_3_",
"timestep=15_finish_4_",
"timestep=15_finish_5_",
"timestep=15_finish_6_",
"timestep=15_finish_7_",
"timestep=15_finish_8_",
"timestep=15_finish_9_",

            ]
            
            k_1 = ["timestep=15_finish_0_final",
"timestep=15_finish_1_final",
"timestep=15_finish_10_final",
"timestep=15_finish_11_final",
"timestep=15_finish_12_final",
"timestep=15_finish_13_final",
"timestep=15_finish_14_final",
"timestep=15_finish_15_final",
"timestep=15_finish_16_final",
"timestep=15_finish_17_final",
"timestep=15_finish_18_final",
"timestep=15_finish_19_final",
"timestep=15_finish_2_final",
"timestep=15_finish_20_final",
"timestep=15_finish_21_final",
"timestep=15_finish_22_final",
"timestep=15_finish_23_final",
"timestep=15_finish_24_final",
"timestep=15_finish_25_final",
"timestep=15_finish_26_final",
"timestep=15_finish_27_final",
"timestep=15_finish_28_final",
"timestep=15_finish_29_final",
"timestep=15_finish_3_final",
"timestep=15_finish_4_final",
"timestep=15_finish_5_final",
"timestep=15_finish_6_final",
"timestep=15_finish_7_final",
"timestep=15_finish_8_final",
"timestep=15_finish_9_final",
            ...
            for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
                ...
                while booltemp == True:
                    ...
                    if iter_ % 2 == 0:
                        ...
                        if iter_ == 0:
                            ...
                            c_start = time.time()
                            css = ddp.solve(xs, us, 10, False, 0.001)
                ...
                if time1 % 50 == 0:
                    filename = '/home/jhk/walkingdata/beforedata/fdyn/timestep=1_finish/'
                    #filename1 = 'test1'
                    #filename2 = '.pkl'

...
def talker():
    ...
    for step_time in range(0, 1):
        f = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/lfoot1_ssp1_1.txt", 'r')
        f1 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/rfoot1_ssp1_1.txt", 'r')
        f2 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/zmp2_ssp1_1.txt", 'r')
        ...
        filename3 = '/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/integrate/Fdyn_data5_8_7.txt'
        ...
        for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            weight_quad_zmp = np.array([6.0, 6.0])#([weight_quad_zmpx] + [weight_quad_zmpy])
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    print("b")
                    if iter_ == 1:
                        css = ddp.solve(ddp.xs, ddp.us, 200, False)
                    else:
                        css = ddp.solve(xs, us, 100, False, 0.001)
            ...
            if time1 % 1000 == 0:
                filename = '/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/integrate/filename3_8_7.pkl'
                #filename1 = 'test1'
                #filename2 = '.pkl'

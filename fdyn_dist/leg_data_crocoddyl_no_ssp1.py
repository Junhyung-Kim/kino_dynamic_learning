...
def talker():
    ...
    for step_time in range(0,1):
        f = open("/home/jhk/walkingdata1/beforedata/ssp1/30cm/timestep=18/lfoot1_ssp1_1.txt", 'r')
        f1 = open("/home/jhk/walkingdata1/beforedata/ssp1/30cm/timestep=18/rfoot1_ssp1_1.txt", 'r')
        f2 = open("/home/jhk/walkingdata1/beforedata/ssp1/30cm/timestep=18/timestep0_zmp2_ssp1_1.txt", 'r')
        ...
        k_1 = ["ssp1_data7_5_3_0.0021_0.txt", 
]

        for kkk in range(0, len(k_1), 1): #42
            crocs_data = dict()
            ...
            #k = adsfsdf
            filename3 = '/home/jhk/walkingdata1/beforedata/ssp1/30cm/timestep=18/'
            ...
            for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
                ...
                k_ = ["filename7_5_3_0.0021_0.txt",
]


                if time1 % 5 == 0:
                    filename = '/home/jhk/walkingdata1/beforedata/ssp1/30cm/timestep=18/'

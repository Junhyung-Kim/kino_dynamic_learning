...
def talker():
    ...
    for step_time in range(17, 18):
        ...
        for kkkk in range(0, 500, 1):
            ...
            k_ = [ "timestep=16_finish_30_final",
"timestep=16_finish_31_final",
"timestep=16_finish_310_final",
"timestep=16_finish_311_final",
"timestep=16_finish_312_final",
"timestep=16_finish_313_final",
"timestep=16_finish_314_final",
"timestep=16_finish_315_final",
"timestep=16_finish_316_final",
"timestep=16_finish_317_final",
"timestep=16_finish_318_final",
"timestep=16_finish_319_final",
"timestep=16_finish_32_final",
"timestep=16_finish_320_final",
"timestep=16_finish_321_final",
"timestep=16_finish_322_final",
"timestep=16_finish_323_final",
"timestep=16_finish_324_final",
"timestep=16_finish_325_final",
"timestep=16_finish_326_final",
"timestep=16_finish_327_final",
"timestep=16_finish_328_final",
"timestep=16_finish_329_final",
"timestep=16_finish_33_final",
"timestep=16_finish_34_final",
"timestep=16_finish_35_final",
"timestep=16_finish_36_final",
"timestep=16_finish_37_final",
"timestep=16_finish_38_final",
"timestep=16_finish_39_final",
]
            
            k_1 = ["timestep=17_finish_30",
"timestep=17_finish_31",
"timestep=17_finish_310",
"timestep=17_finish_311",
"timestep=17_finish_312",
"timestep=17_finish_313",
"timestep=17_finish_314",
"timestep=17_finish_315",
"timestep=17_finish_316",
"timestep=17_finish_317",
"timestep=17_finish_318",
"timestep=17_finish_319",
"timestep=17_finish_32",
"timestep=17_finish_320",
"timestep=17_finish_321",
"timestep=17_finish_322",
"timestep=17_finish_323",
"timestep=17_finish_324",
"timestep=17_finish_325",
"timestep=17_finish_326",
"timestep=17_finish_327",
"timestep=17_finish_328",
"timestep=17_finish_329",
"timestep=17_finish_33",
"timestep=17_finish_34",
"timestep=17_finish_35",
"timestep=17_finish_36",
"timestep=17_finish_37",
"timestep=17_finish_38",
"timestep=17_finish_39",

]
            
            
            filename = '/home/jhk/walkingdata/beforedata/fdyn/'#'/home/jhk/walkingdata/beforedata/fdyn_int/timestep=47/'
            ...
            e = 0
            for time1 in range(0, len(database_['Right']['trajs']),1):#15, len(database_['Right']['trajs'])):
                ...
                weight_quad_zmp1 = np.array([0.5, 0.5]) ##11 0.5,0.5
                ...
                '''
                for i in range(0,N):
                    xs[i] = xs[0]#np.append(np.append(database_['Right']['trajs'][time1][i], database_['Right']['vel_trajs'][time1][i]),database_['Right']['x_state'][time1][i])
            
                for i in range(0,N-1):
                    us[i] = np.zeros(24)#us[0]
                    #np.append(database_['Right']['u_trajs'][time1][i] ,database_['Right']['acc_trajs'][time1][i])#np.append(np.append(database_['Right']['u_trajs'][time1][i+1], database_['Right']['acc_trajs'][time1][i][0]), database_['Right']['acc_trajs'][time1][i][2])
                '''

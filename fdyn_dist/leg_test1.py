...
def loadmodel(kkkk):
    ...
    filename = '/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/integrate'
    filename2 = '/Fdyn_data5_7_7.txt'
...
def talker():
    ...
    for kkkk in range(0,1):
        ...
        f3 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/newfile.txt", 'w')
        f1 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/newfile7.txt", 'w')
        f2 = open("/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/newfile7.txt", 'w')
        zmpx = []
        zmpy = []
        #print(zmp_refx)
        ...
        for time1 in range(0, len(database1['Right']['vel_trajs'])):
            ...
            '''
            if time1 % 200 == 0:
                filename3 = '/home/jhk/ssd_mount2/beforedata/fdyn_int/timestep=13/integrate/Fdyn_data5_8_7.txt' #filename + filename1 + filename2

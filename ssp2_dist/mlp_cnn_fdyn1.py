...
"timestep=49_finish_ssp2",
    ...
    if learn_type == 0:
        ...
        print("loss_graph")
        print(loss_graph[2])
        file_name = '/home/jhk/ssd_mount/beforedata/fdyn/cnnEarly_normal_leakylow'
        file_name2 = '0_'
        file_name3 = '.pkl'
        file_name4 = file_name  +file_name2+ naming[time_step]+ file_name3       
        ...
        file_name3 = file_name +'loss_normalsLeakylow' +naming[time_step] +  '.txt'
...
def talker():
    ...
    for i in range(6, 49, 6):#learning_data_num):
        PCAlearning(i)
    k = adsfasdff
    print("start")

...
def talker():
    ...
    for ss in range(0, 5):
        print(ss)
        print(crocs_data['Right']['x_state'][time1d][ss][0] + 0.02 * crocs_data['Right']['x_state'][time1d][ss+1][1]-crocs_data['Right']['x_state'][time1d][ss+1][0])
        print(crocs_data['Right']['x_state'][time1d][ss][4] + 0.02 * crocs_data['Right']['x_state'][time1d][ss+1][5]-crocs_data['Right']['x_state'][time1d][ss+1][4])
        print(crocs_data['Right']['x_state'][time1d][ss][2] + 0.02 * crocs_data['Right']['acc_trajs'][time1d][ss][0]- crocs_data['Right']['x_state'][time1d][ss+1][2])
        print(crocs_data['Right']['x_state'][time1d][ss][6] + 0.02 * crocs_data['Right']['acc_trajs'][time1d][ss][2]- crocs_data['Right']['x_state'][time1d][ss+1][6])
        print(crocs_data['Right']['x_state'][time1d][ss][3] + 0.02 * crocs_data['Right']['acc_trajs'][time1d][ss][1]- crocs_data['Right']['x_state'][time1d][ss+1][3])
        print(crocs_data['Right']['x_state'][time1d][ss][7] + 0.02 * crocs_data['Right']['acc_trajs'][time1d][ss][3]- crocs_data['Right']['x_state'][time1d][ss+1][7])

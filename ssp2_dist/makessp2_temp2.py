...
#"timestep=40_finish_re",
    ...
    timesstep = [37, 12, 13, 15, 16, 17, 18, 20, 22, 23, 24, 26, 27, 28, 29, 30, 31, 33]
    
    for kkkk in range(0,len(k_),100):
        database = dict()
        database['Right'] = dict()
        ...
        #if kkkk <= 9:
        #    filename = '/home/jhk/walkingdata/beforedata/ssp2/file1/'
        #elif kkkk <= 16:
        #    filename = '/home/jhk/ssd_mount3/beforedata/ssp2/'
        #else:
        filename = '/home/jhk/walkingdata/beforedata/ssp2/file/'

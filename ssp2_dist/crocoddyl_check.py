...
"timestep=22_finish222"  , "timestep=22_finish2232" , "timestep=22_finish223" ,
            ...
            filename = '/home/jhk/walkingdata/beforedata/ssp2/'#'/home/jhk/walkingdata/beforedata/fdyn_int/timestep=47/'
            ...
            if data_processing == True:
                ...
                for key in database_.keys():
                    ...
                    database_[key]['costs'] = []
                    database_[key]['iters'] = []
                for i in range(0, 1):#len(database[key]['trajs'])):

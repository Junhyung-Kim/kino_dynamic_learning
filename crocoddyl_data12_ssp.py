...
def talker():
    ...
    with open('/home/jhk/ssd_mount/beforedata/ssp/i=1-3,10,10,10/Fdyn_data7.txt', 'rb') as f:
    ...
    for time1 in range(0, len(database_['Right']['u_trajs'])):#15, len(database_['Right']['trajs'])):
        ...
        while booltemp == True:
            ...
            if iter_ % 2 == 0:
                ...
                print("b")
                css = ddp.solve(ddp.xs, ddp.us, 1, False, 0.1)
            c_end = time.time()
            ...
            if booltemp1 == False:
                ...
                with open('/home/jhk/ssd_mount/beforedata/ssp/i=1-3,10,10,10/filename3.pkl', 'wb') as f:

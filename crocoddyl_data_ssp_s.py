...
def talker():
    ...
    for kkkk in range(9, 10):
        ...
        filename = '/home/jhk/ssd_mount/beforedata/ssp2/none/i='
        filename1 = str(kkkk)
        ...
        e = 0
        for time1 in range(2463, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                if iter_ % 2 == 0:
                    ...
                    print("a")
                    if iter_ == 0:
                        css = ddp.solve(xs, us, 2000, False, 0.1)
                else:
                    print("b")

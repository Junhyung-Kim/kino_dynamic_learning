...
def talker():
    ...
    with open('/home/jhk/ssd_mount/afterprocessing/1/filename2.pkl', 'rb') as f:
    ...
    for i in range(0, N-1):
        ...
        for j in range(0, len(qddot)):
            qddot[j] = crocs_data['Right']['u_trajs'][time1d][i][j]
       ...
       # print(a)
        ...
        print("cam")
        #a = [crocs_data['Right']['acc_trajs'][time1d][i][3], crocs_data['Right']['acc_trajs'][time1d][i][1], 0.0]
        a = [crocs_data['Right']['x_state'][time1d][i][7], crocs_data['Right']['x_state'][time1d][i][3], 0.0]
        print(data.hg.angular - a)
        #print(crocs_data['Right']['acc_trajs'][time1d][i],)
    ...
    '''
    for i in range(0, N):
        if (database_['Right']['x_state'][0][i][2] > array_boundx_[i][0]) and (database_['Right']['x_state'][0][i][2] < array_boundx_[i][1]):
            a1 = 0
        else:
            print("zmpx not ok")
            print(i)
        if (database_['Right']['x_state'][0][i][6] > array_boundy_[i][0]) and (database_['Right']['x_state'][0][i][6] < array_boundy_[i][1]):
            a1 = 0
        else:
            print("zmpy not ok")
            print(i)
    ...
    for i in range(0, N):
        ...
        print(array_boundx_[i])
        print(array_boundy_[i])
        print(database_['Right']['x_state'][15][i])
        print("com")
    '''

    
    #print(database_['Right']['trajs'][0][238])
    #print(database_['Right']['trajs'][0][239])
    ...
    for i in range(0, len(crocs_data['Right']['trajs'])):
        if(crocs_data['Right']['costs'][i] > 0.012):
            print(crocs_data['Right']['costs'][i])
    '''
    for i in range(0, N):
        a = [crocs_data['Right']['x_state'][time1d][i][0], crocs_data['Right']['x_state'][time1d][i][4], 0.0]
        print(array_boundy_[i])
        print(a)
        print([crocs_data['Right']['x_state'][time1d][i][2], crocs_data['Right']['x_state'][time1d][i][6]])
        print([crocs_data['Right']['trajs'][time1d][i][0:3], crocs_data['Right']['trajs'][time1d][i][0:3]])
    '''
    '''
    for i in range(0,N-1):
        ...
        state_activations[i] = crocoddyl.ActivationModelWeightedQuadraticBarrier(state_bounds[i])
    ...
    state_activations[N-1] = crocoddyl.ActivationModelWeightedQuadraticBarrier(state_bounds[N-1])

...
def talker():
    ...
    with open('/home/jhk/ssd_mount/beforedata/i=1-4,j=0-10,2/Fdyn_data7.txt', 'rb') as f:
    #with open('/home/jhk/ssd_mount/afterdata/i=1-4,j=0-10,2/Fdyn_data5.txt', 'rb') as f:
        database = pickle.load(f,  encoding='iso-8859-1')
    f.close()
    ...
    for time1 in range(0, len(database_['Right']['u_trajs'])):#15, len(database_['Right']['trajs'])):
        ...
        while booltemp == True:
            ...
            if booltemp1 == False:
                ...
                with open('/home/jhk/ssd_mount/beforedata/i=1-4,j=0-10,2/filename3.pkl', 'wb') as f:

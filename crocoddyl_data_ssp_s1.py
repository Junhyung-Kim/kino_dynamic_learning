    ...
    for step_time in range(7, 9):
        ...
        for time1 in range(0, len(database_['Right']['trajs'])):#15, len(database_['Right']['trajs'])):
            ...
            while booltemp == True:
                ...
                c_start = time.time()
                if iter_ % 2 == 0:
                    ddp.th_stop = 0.000003
                    print("a")
                    if iter_ == 0:
                        css = ddp.solve(xs, us, 10000, False, 0.008)
                else:
                    print("b")
                    css = ddp.solve(ddp.xs, ddp.us, 10000, False, 0.008)
                ...
                if booltemp1 == False:
                    ...
                    filename = '/home/jhk/ssd_mount/beforedata/ssp2/integral/filename3_4_'
